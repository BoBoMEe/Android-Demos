...
public class SystemUtil {
    ...
    public static long getExternalTotalSpace(Context context) {
        long totalSpace = -1L;
        if (StorageUtil.isExternalReadable(context)) {
            try {
    ...
    public static int getCpuCores() {
        ...
        if (sCoreNum == 0) {
            try {
                ...
                Log.e(TAG, "getCpuCores exception occurred, e=", e);
                sCoreNum = 1;
            }
        }
        return sCoreNum;
    ...
    public static long getTotalMemory() {
        if (sTotalMemo == 0) {
            ...
            try {
                ...
                Log.e(TAG, "getTotalMemory Exception occurred, e =", e);
            } finally {
                if (localFileReader != null) {
                    try {
                        localFileReader.close();
                    } catch (IOException e) {
                        Log.e(TAG, "close localFileReader Exception occurred, e = ", e);
                    }
                }
            }
